...
#ifndef ANIMATION_EDITOR_OLD_INCLUDED
#define ANIMATION_EDITOR_OLD_INCLUDED
...
private:
    ...
    enum animation_editor_old_PICKER_TYPES {
...
#endif //ifndef ANIMATION_EDITOR_OLD_INCLUDED
