...
const float  area_editor_old::DEBUG_TEXT_SCALE = 1.5f;
//Default grid interval.
const float  area_editor_old::DEF_GRID_INTERVAL = 32.0f;
...
const size_t area_editor_old::MAX_CIRCLE_SECTOR_POINTS = 32;
...
const size_t area_editor_old::MIN_CIRCLE_SECTOR_POINTS = 3;
//Minimum grid interval.
const float  area_editor_old::MIN_GRID_INTERVAL = 2;
...
const float  area_editor_old::PATH_PREVIEW_TIMEOUT_DUR = 0.1f;
...
const float  area_editor_old::ZOOM_MIN_LEVEL_EDITOR = 0.05f;

const string area_editor_old::EDITOR_ICONS_FOLDER_NAME = "Editor_icons";
const string area_editor_old::DELETE_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Delete.png";
const string area_editor_old::DELETE_LINK_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Delete_link.png";
const string area_editor_old::DELETE_STOP_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Delete_stop.png";
const string area_editor_old::DUPLICATE_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Duplicate.png";
const string area_editor_old::EXIT_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Exit.png";
const string area_editor_old::NEW_CIRCLE_SECTOR_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/New_circle_sector.png";
const string area_editor_old::NEW_1WLINK_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/New_1wlink.png";
const string area_editor_old::NEW_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/New.png";
const string area_editor_old::NEW_LINK_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/New_link.png";
const string area_editor_old::REFERENCE_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Reference.png";
const string area_editor_old::NEW_STOP_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/New_stop.png";
const string area_editor_old::NEXT_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Next.png";
const string area_editor_old::OPTIONS_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Options.png";
const string area_editor_old::PREVIOUS_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Previous.png";
const string area_editor_old::SAVE_ICON =
    EDITOR_ICONS_FOLDER_NAME + "/Save.png";
const string area_editor_old::SELECT_NONE_ICON =
...
area_editor_old::area_editor_old() :
    ...
    error_type(area_editor_old::EET_NONE_YET),
 ...
 */
void area_editor_old::adv_textures_to_gui() {
    if(!cur_sector) {
 ...
 */
point area_editor_old::snap_to_grid(const point &p) {
 ...
 */
void area_editor_old::shadow_to_gui() {
    lafi::frame* f =
 ...
 */
void area_editor_old::gui_to_adv_textures() {
 ...
 */
void area_editor_old::gui_to_reference() {
 ...
 */
void area_editor_old::gui_to_sector(bool called_by_brightness_bar) {
    if(!cur_sector) return;
    lafi::frame* f =
        (lafi::frame*) gui->widgets["frm_sectors"]->widgets["frm_sector"];
 ...
 */
void area_editor_old::gui_to_shadow() {
 ...
 */
void area_editor_old::cancel_new_sector() {
 ...
 */
void area_editor_old::center_camera(
 ...
 */
void area_editor_old::change_reference(string new_file_name) {
...
void area_editor_old::hide_all_frames() {
    ...
    gui->widgets["frm_sectors"]->hide();
    gui->widgets["frm_paths"]->hide();
    gui->widgets["frm_adv_textures"]->hide();
    gui->widgets["frm_texture"]->hide();
    gui->widgets["frm_objects"]->hide();
    gui->widgets["frm_shadows"]->hide();
    gui->widgets["frm_reference"]->hide();
    gui->widgets["frm_review"]->hide();
    gui->widgets["frm_tools"]->hide();
    gui->widgets["frm_options"]->hide();
...
void area_editor_old::clear_current_area() {
    ((lafi::button*) gui->widgets["frm_main"]->widgets["but_area"])->text =
        area_name;
    gui->widgets["frm_main"]->widgets["frm_area"]->show();
 ...
 */
void area_editor_old::create_new_from_picker(const string &name) {
 ...
 */
void area_editor_old::create_sector() {
 ...
 */
void area_editor_old::find_errors() {
    error_type = EET_NONE;
    error_sector_ptr = NULL;
    error_vertex_ptr = NULL;
    error_string.clear();
 ...
 */
void area_editor_old::goto_error() {
 ...
 */
bool area_editor_old::is_new_sector_line_valid(const point &pos) {
 ...
 */
void area_editor_old::pick(const string &name, const unsigned char type) {
    if(type == AREA_EDITOR_PICKER_AREA) {
        area_name = name;
        load_area(false);
 ...
 */
void area_editor_old::reference_to_gui() {
    lafi::frame* f = (lafi::frame*) gui->widgets["frm_reference"];
 ...
 */
bool area_editor_old::remove_isolated_sector(sector* s_ptr) {
 ...
 */
void area_editor_old::resize_everything() {
 ...
 */
void area_editor_old::save_area(const bool to_backup) {
 ...
 */
void area_editor_old::toggle_duplicate_mob_mode() {
 ...
 */
void area_editor_old::update_options_frame() {
 ...
 */
void area_editor_old::update_review_frame() {
 ...
 */
void area_editor_old::update_transformations() {
 ...
 * in the same spot.
 */
void area_editor_old::zoom(const float new_zoom) {
    cam_zoom =
 ...
 */
void area_editor_old::set_reference_file_name(const string &n) {
 ...
 */
void area_editor_old::set_reference_pos(const point &p) {
    reference_pos = p;
}
 ...
 */
void area_editor_old::set_reference_size(const point &p) {
    reference_size = p;
}
 ...
 */
void area_editor_old::set_reference_a(const unsigned char a) {
    reference_a = a;
}
