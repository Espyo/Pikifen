...
#ifndef AREA_EDITOR_OLD_INCLUDED
#define AREA_EDITOR_OLD_INCLUDED
...
private:
    ...
    struct layout_drawing_node {
        ...
        bool is_new_vertex;
        layout_drawing_node(area_editor_old* ae_ptr, const point &mouse_click);
        layout_drawing_node();
    };
...
#endif //ifndef AREA_EDITOR_OLD_INCLUDED
