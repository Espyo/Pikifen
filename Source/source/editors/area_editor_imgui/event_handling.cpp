 ...
 *
 * === FILE DESCRIPTION ===
 * Area editor Allegro event handling functions.
 */
 ...
 */
void area_editor_imgui::handle_lmb_double_click(const ALLEGRO_EVENT &ev) {
    //TODO
    /*
    if(!(frm_picker->flags & lafi::FLAG_INVISIBLE)) {
        return;
 ...
 */
void area_editor_imgui::handle_lmb_down(const ALLEGRO_EVENT &ev) {
    //TODO
    /*
    if(!(frm_picker->flags & lafi::FLAG_INVISIBLE)) {
        return;
 ...
 */
void area_editor_imgui::handle_lmb_drag(const ALLEGRO_EVENT &ev) {
    //TODO
    /*
    if(!(frm_picker->flags & lafi::FLAG_INVISIBLE)) {
        return;
 ...
 */
void area_editor_imgui::handle_lmb_up(const ALLEGRO_EVENT &ev) {
    //TODO
    /*if(!(frm_picker->flags & lafi::FLAG_INVISIBLE)) {
        return;
    }
 ...
 */
void area_editor_imgui::handle_mmb_double_click(const ALLEGRO_EVENT &ev) {
    if(!editor_mmb_pan) {
        reset_cam_xy(ev);
    }
}
 ...
 */
void area_editor_imgui::handle_mmb_down(const ALLEGRO_EVENT &ev) {
    if(!editor_mmb_pan) {
        reset_cam_zoom(ev);
    }
}
 ...
 */
void area_editor_imgui::handle_mmb_drag(const ALLEGRO_EVENT &ev) {
    if(editor_mmb_pan) {
        pan_cam(ev);
    }
}
 ...
 */
void area_editor_imgui::handle_mouse_update(const ALLEGRO_EVENT &ev) {
 ...
 */
void area_editor_imgui::handle_mouse_wheel(const ALLEGRO_EVENT &ev) {
 ...
 */
void area_editor_imgui::handle_rmb_double_click(const ALLEGRO_EVENT &ev) {
    if(editor_mmb_pan) {
        reset_cam_xy(ev);
    }
}
 ...
 */
void area_editor_imgui::handle_rmb_down(const ALLEGRO_EVENT &ev) {
    if(editor_mmb_pan) {
        reset_cam_zoom(ev);
    }
}
 ...
 * Handles the right mouse button being dragged.
 */
void area_editor_imgui::handle_rmb_drag(const ALLEGRO_EVENT &ev) {
    if(!editor_mmb_pan) {
        pan_cam(ev);
    }
}
 ...
 */
void area_editor_imgui::pan_cam(const ALLEGRO_EVENT &ev) {
 ...
 */
void area_editor_imgui::reset_cam_xy(const ALLEGRO_EVENT &ev) {
    cam_pos.x = 0;
    cam_pos.y = 0;
}
 ...
 */
void area_editor_imgui::reset_cam_zoom(const ALLEGRO_EVENT &ev) {
    zoom(1.0f);
}
