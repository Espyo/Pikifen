...
const float MATURITY_POWER_MULT         = 0.1f;      //Every level of maturity, multiply the power by 1 + this much.
const float MATURITY_SPEED_MULT         = 0.1f;      //Every level of maturity, multiply the speed by 1 + this much.
...
enum HUD_ELEMENTS {
    ...
    HUD_ITEM_SPRAY_CUR_ICON,
    HUD_ITEM_SPRAY_CUR_AMOUNT,
    HUD_ITEM_SPRAY_CUR_KEY,
