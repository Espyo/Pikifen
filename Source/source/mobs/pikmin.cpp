...
void pikmin::fsm_become_buried(mob* m, void* info1, void* info2) {
    m->set_animation(PIKMIN_ANIM_BURROWED);
}

void pikmin::fsm_begin_pluck(mob* m, void* info1, void* info2) {
    pikmin* pik = (pikmin*) m;
    mob* lea = (mob*) info1;
...
void pikmin::fsm_end_pluck(mob* m, void* info1, void* info2) {
    pikmin* pik = (pikmin*) m;
...
void pikmin::fsm_be_grabbed_by_friend(mob* m, void* info1, void* info2) {
    sfx_pikmin_held.play(0, false);
    m->set_animation(PIKMIN_ANIM_IDLE);
}

void pikmin::fsm_be_grabbed_by_enemy(mob* m, void* info1, void* info2) {
...
void pikmin::fsm_be_dismissed(mob* m, void* info1, void* info2) {
    m->set_target(
        *(float*) info1,
        *(float*) info2,
        NULL,
...
void pikmin::fsm_reach_dismiss_spot(mob* m, void* info1, void* info2) {
    m->remove_target();
    m->set_animation(PIKMIN_ANIM_IDLE);
}

void pikmin::fsm_become_idle(mob* m, void* info1, void* info2) {
    m->set_animation(PIKMIN_ANIM_IDLE);
    unfocus_mob(m);
}

void pikmin::fsm_be_thrown(mob* m, void* info1, void* info2) {
    m->remove_target();
...
void pikmin::fsm_be_released(mob* m, void* info1, void* info2) {

}

void pikmin::fsm_land(mob* m, void* info1, void* info2) {
    m->set_animation(PIKMIN_ANIM_IDLE);
    pikmin::fsm_stand_still(m, NULL, NULL);
}

void pikmin::fsm_stand_still(mob* m, void* info1, void* info2) {
    m->remove_target();
    m->speed_x = m->speed_y = 0;
}

void pikmin::fsm_called(mob* m, void* info1, void* info2) {
    pikmin* pik = (pikmin*) m;
...
void pikmin::fsm_get_knocked_down(mob* m, void* info1, void* info2) {
...
void pikmin::fsm_go_to_opponent(mob* m, void* info1, void* info2) {
...
void pikmin::fsm_rechase_opponent(mob* m, void* info1, void* info2) {
    if(
        m->focused_mob &&
...
void pikmin::fsm_go_to_carriable_object(mob* m, void* info1, void* info2) {
...
void pikmin::fsm_reach_carriable_object(mob* m, void* info1, void* info2) {
    pikmin* pik_ptr = (pikmin*) m;
...
void pikmin::fsm_forget_carriable_object(mob* m, void* info1, void* info2) {
    pikmin* p = (pikmin*) m;
...
void pikmin::fsm_stop_carrying(mob* m, void* info1, void* info2) {
    pikmin* p = (pikmin*) m;
    if(!p->focused_mob) return;
...
void pikmin::fsm_prepare_to_attack(mob* m, void* info1, void* info2) {
    pikmin* p = (pikmin*) m;
...
void pikmin::fsm_land_on_mob(mob* m, void* info1, void* info2) {
    pikmin* pik_ptr = (pikmin*) m;
    hitbox_touch_info* info = (hitbox_touch_info*) info1;
...
void pikmin::fsm_lose_latched_mob(mob* m, void* info1, void* info2) {
    m->remove_target();
}

void pikmin::fsm_tick_grabbed_by_enemy(mob* m, void* info1, void* info2) {
    pikmin* pik_ptr = (pikmin*) m;
...
void pikmin::fsm_tick_latched(mob* m, void* info1, void* info2) {
    pikmin* pik_ptr = (pikmin*) m;
    if(!pik_ptr->focused_mob) return;
...
void pikmin::fsm_tick_attacking_grounded(mob* m, void* info1, void* info2) {
    pikmin* pik_ptr = (pikmin*) m;
    pik_ptr->attack_time -= delta_t;
...
void pikmin::fsm_fall_down_pit(mob* m, void* info1, void* info2) {
    m->health = 0;
}

void pikmin::fsm_chase_leader(mob* m, void* info1, void* info2) {
    m->set_target(
...
void pikmin::fsm_stop_being_idle(mob* m, void* info1, void* info2) {

}

void pikmin::fsm_stop_in_group(mob* m, void* info1, void* info2) {
    m->remove_target();
    m->set_animation(PIKMIN_ANIM_IDLE);
}
