...
void draw_sector(sector* s_ptr, const float x, const float y, const float scale, ALLEGRO_BITMAP* texture = NULL);
void draw_sector_texture(sector* s_ptr, const float x, const float y, const float scale, ALLEGRO_BITMAP* texture = NULL);
