...
ALLEGRO_BITMAP* bmp_purple[3] = {NULL, NULL, NULL};
...
ALLEGRO_BITMAP* bmp_white[3] = {NULL, NULL, NULL};
...
map<string, animation> ed_anims;
animation*            ed_anim = NULL;
string                ed_anim_name;
bool                  ed_anim_playing = false;
size_t                ed_cur_frame_nr = string::npos;
float                 ed_cur_frame_time = 0;
float                 ed_cur_hitbox_angle = 0;
size_t                ed_cur_hitbox_nr = string::npos;
...
lafi_label*           ed_gui_status_bar = NULL;
bool                  ed_hitboxes_visible = true;
bool                  ed_holding_m2 = false;
unsigned char         ed_mode = EDITOR_MODE_NORMAL;
