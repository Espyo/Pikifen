...
unsigned char         cur_screen = SCREEN_ANIMATION_EDITOR;
weather               cur_weather;
...
ALLEGRO_BITMAP*       editor_cur_bmp = NULL;
size_t                editor_cur_hitbox_nr = string::npos;
vector<hitbox>        editor_cur_hitboxes;
lafi_gui*             editor_gui = NULL;
lafi_label*           editor_gui_status_bar = NULL;
bool                  editor_holding_m2 = false;
unsigned char         editor_mode = EDITOR_MODE_NORMAL;
float                 editor_new_hitbox_center_x = FLT_MAX;
float                 editor_new_hitbox_center_y = FLT_MAX;
float                 editor_new_hitbox_radius = 0;
