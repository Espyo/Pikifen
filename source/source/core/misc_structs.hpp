...
#include "../content/mob/mob_enums.hpp"
#include "../content/other/hazard.hpp"
#include "../content/other/particle.hpp"
...
extern const size_t OUTPUT_INDENT;
extern const size_t OUTPUT_MAX_CHARS_PER_LINE;
